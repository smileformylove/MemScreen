...
class IntelligentModelRouter:
    ...
    def _initialize_default_configs(self):
        ...
        self.model_configs.update({
            "qwen3.5:0.8b": ModelConfig("qwen3.5:0.8b", ModelTier.TINY, avg_latency_ms=95, quality_score=0.79),
            "qwen3.5:2b": ModelConfig("qwen3.5:2b", ModelTier.SMALL, avg_latency_ms=135, quality_score=0.84),
            "qwen3.5:4b": ModelConfig("qwen3.5:4b", ModelTier.SMALL, avg_latency_ms=180, quality_score=0.89),
            "qwen3.5:9b": ModelConfig("qwen3.5:9b", ModelTier.MEDIUM, avg_latency_ms=360, quality_score=0.93),
